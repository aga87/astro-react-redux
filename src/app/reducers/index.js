...
import audio, * as fromAudio from './audio';

export default combineReducers({ game, ui, audio });
...
export const isPlaying = (state) => fromAudio.isPlaying(state.audio);
export const getCurrentId = (state) => fromAudio.getCurrentId(state.audio);
